      ...
      <div className="max-w-md w-full space-y-8 animate-fadeIn">
        ...
        <Card className="shadow-2xl animate-slideUp" style={{ animationDelay: '150ms' }}>
          <div className="px-8 py-8">
            <div className="mb-6">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 text-center">Get Started</h2>
              <p className="text-gray-600 dark:text-gray-400 text-center mt-1">Create your organisation account</p>
            </div>
        ...
        <p className="text-center text-primary-100 text-sm animate-slideUp" style={{ animationDelay: '300ms' }}>
          Join thousands of organisations using Evallo HRMS
        </p>
      </div>
    </div>
  );
